...
export const deadGritMessages = {
    cowardly: 'you died willingly.',
    comfortable: 'you died but tried a little at the end to survive.',
    brave: 'you died doing something courageous.'
};

export const hpMessages = {
    dead: 'RIP.',
    frail: 'you are home but in frail health.',
    healthy: 'you are fit as a fiddle.'
};